...
@Component({
  selector: 'app-fivetemp',
  templateUrl: './fivetemp.component.html',
  styleUrls: ['./fivetemp.component.css']
})
export class FivetempComponent implements OnInit {
  templateid  ='fivetemp';
  urlid = '';
  ...
  save(){
    ...
    var data = document.getElementById('container') as HTMLCanvasElement;
