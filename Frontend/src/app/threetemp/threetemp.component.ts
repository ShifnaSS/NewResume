...
@Component({
  selector: 'app-threetemp',
  templateUrl: './threetemp.component.html',
  styleUrls: ['./threetemp.component.css']
})
export class ThreetempComponent implements OnInit {
  templateid  ='threetemp';
  urlid = '';
